...
class ReportPost extends Component { 
  ...
  async handleSubmit(event) {
    ...
    const photoURL = user.photoURL;
      ...
      alert('A  report on a post submitted: ' + this.state.value) ;
      const docRef = await addDoc(collection(db, "reportedPost"), {
        message: this.state.value,
        userId: user.uid,
        ReporteditemId: this.props.itemId ,
...
export  function ReportPostWithProps(props){
 ...
 return(
  <ReportPost navigation={navigation} route={route} itemId={itemId} report={report}/>
 )
}
